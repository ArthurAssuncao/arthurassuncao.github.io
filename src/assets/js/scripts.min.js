...
app.controller("AppController", function($scope, $timeout, $mdSidenav, $log, toastService) {
    ...
    em_manutencao(), remove_form_send_by_enter(), hide_form_result(), hide_habilidades_itens(), 
    fill_skills(), add_habilidades_more_event(), iniciar_wow(), add_contact_form_click(), 
    $(window).scroll(on_scroll_menu), ativar_modals(), iniciar_parallax();
});
