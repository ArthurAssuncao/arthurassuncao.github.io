...
?>
    ...
    <div id="portfolio_slide" class="imageflow">
        <img id="addmob_site" src="img/portfolio/apresentacao_site_addmob_reflexo.jpg" longdesc="URL_1" width="200" height="200" alt="<a href='http://addmob.com.br'>Website Addmob.com.br</a>" />
        <img id="addmob_site" src="img/portfolio/apresentacao_site_addmob_reflexo.jpg" longdesc="URL_1" width="200" height="200" alt="Website Addmob.com.br" />
    </div>

    <div id="lightbox_addmob_site" class="lightbox fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="lightbox-dialog">
            <div class='lightbox-content'>
                <img src="img/portfolio/apresentacao_site_addmob_reflexo.jpg" />
                <div>
...
<?php
    ...
    $pagina->addJavascript('js/bootstrap3/bootstrap.min.js');
    ...
    $embedded_js_footer = "
        domReady(function(){
            ...
            imageFlow.init({
                ...
                onClick: function() {\$('#lightbox_' + this.id).lightbox({
                    show: true,
                    resizeToFit: true
                    });}
            });
